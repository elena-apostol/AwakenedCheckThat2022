...
if __name__ =="__main__":
    ...
    x_train = sio.loadmat(os.path.join(DIR_NAME, 'D2V_BART_TRAIN.mat'))['X']
    x_test = sio.loadmat(os.path.join(DIR_NAME, 'D2V_BART_TEST.mat'))['X']
    ...
    with open("subtask3_english_awakened.tsv", "a") as f:
